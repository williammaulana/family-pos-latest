/*
  ...
  ### users table
  - Authenticated users can view all user records
  ...
  - Authenticated users can view their own transaction details
  
  ### transaction_items table
  - Authenticated users can view all transaction items
  - Authenticated users can insert new transaction items
